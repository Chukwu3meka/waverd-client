...
You need to signin in order to initiate Data Deletion, visit this link [Request Account deletion](https://www.waverd.com/accounts/data-deletion) to get started.
